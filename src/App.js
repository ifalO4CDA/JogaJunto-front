...
import ConfirmacaoEmail from './pages/cadastro/cadastroUsuario';
...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Routes>
        <Route path="/cadastroUsuario" element={<ConfirmacaoEmail/>}/>
        <Route path="/" element={<HomePage />} />
        <Route path="/arena/:id" element={<ArenaDetalhes />} />
        <Route path="/login" element={<LoginCadastro />} />
        <Route path="/cadastroDadosComplementares" element={<DadosComplementares />} />
      </Routes>
    </div>
  );
}
